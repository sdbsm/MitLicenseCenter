...
public static class SettingDefinitions
{
    public static readonly IReadOnlyDictionary<string, SettingDefinition> All =
        new Dictionary<string, SettingDefinition>(StringComparer.Ordinal)
        {
            ...
            // текст несёт только причину и контакты. Дефолт — на согласование куратора.
            [SettingKey.EnforcementTerminateMessage] = new(
                ...
                Kind: SettingValueKind.Text,
                DefaultValue: "Сеанс завершён: достигнут лимит лицензий 1С. По вопросам расширения лимита обратитесь к вашему провайдеру (укажите здесь телефон и название организации в настройках панели)."),
