...
Полные постановки и отчёты: **`docs/PROJECT_BACKLOG_ARCHIVE.md`** (поиск по `MLC-NNN`).
Номера вне списка: `MLC-025..028`, `MLC-036`, `MLC-062`, `MLC-073` — отложенные опции (см. выше);
`MLC-079`/`MLC-080` — активные (NEXT TASK).
