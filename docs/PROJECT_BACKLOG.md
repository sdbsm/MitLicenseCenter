...
> **Нет активной задачи.** `MLC-074` закрыт (см. индекс «Закрыто»). Следующую `NEXT TASK` ставит внешний
> чат-куратор (исполнитель её сам не выставляет). Кандидат, найденный по ходу и отложенный пользователем, —
> `MLC-073` (UX-полировка раздела «Быстродействие», P3; см. «Открытые опции»).
>
...
## Закрыто (MLC-001..024, 029, 030, 031, 032, 033, 034, 035, 037, 038, 039, 040, 041, 042, 043, 044, 045, 046, 047, 048, 049, 050, 051, 052, 053, 054, 055, 056, 057, 058, 059, 060, 061, 063, 064, 064a, 065, 066, 067, 068, 069, 070, 071, 072, 074) — индекс
