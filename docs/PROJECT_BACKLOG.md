...
> (`MLC-051` CSV/XLSX → `MLC-052` HTML/PDF). Последняя закрытая — `MLC-053` (dev/ops-утилита `reset-admin`,
> 2026-06-07). Все закрыты, отчёты в `PROJECT_BACKLOG_ARCHIVE.md`, см. индекс «Закрыто» ниже.
>
...
## Закрыто (MLC-001..024, 029, 030, 031, 032, 033, 034, 035, 037, 038, 039, 040, 041, 042, 043, 044, 045, 046, 047, 048, 049, 050, 051, 052, 053) — индекс
