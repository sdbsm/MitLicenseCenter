...
> **Нет активной задачи.** Трек «Отчёты»: `MLC-049` (Reports API) **закрыт** 2026-06-06 —
> отчёт в `PROJECT_BACKLOG_ARCHIVE.md`, см. индекс «Закрыто» ниже.
>
> Следующая в цепочке — `MLC-050` (Frontend, раздел «Отчёты»), зависит от закрытого `MLC-049`;
> постановку `NEXT TASK` выставляет внешний чат-куратор (исполнитель сам не выбирает).
>
> Ранее закрытые треки (рефакторинг MLC-029..035, перф MLC-037..043, плюс MLC-044..049) — в индексе
...
## Закрыто (MLC-001..024, 029, 030, 031, 032, 033, 034, 035, 037, 038, 039, 040, 041, 042, 043, 044, 045, 046, 047, 048, 049) — индекс
