...
> _Нет активной задачи._ `MLC-098` закрыт (Done — см. трек ниже); следующую `NEXT TASK`
> по треку «GUI-установщик» ставит куратор (кандидат — `MLC-099`).
...
- `MLC-099` · Build · self-contained single-file publish + publish-скрипт. Status: Open.
