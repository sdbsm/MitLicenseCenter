...
`MLC-001..144` закрыты (кроме отложенных `MLC-025/026/027/145` — см. «Открытые опции»; `MLC-062`/`073`
...
индекс в `PROJECT_BACKLOG_ARCHIVE.md`. Полные отчёты — в git-истории (коммиты `MLC-NNN:`/PR).
