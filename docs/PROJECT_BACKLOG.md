...
> _Нет активной задачи._ Следующую (`MLC-100` — Inno Setup каркас) ставит куратор.
...
- `MLC-100` · Installer · Inno Setup каркас (файлы, Windows-служба, ACL key ring, firewall, старт). Status: Open.
