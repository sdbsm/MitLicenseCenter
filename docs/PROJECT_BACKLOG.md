...
> (`compressed-giggling-grove.md`, PERF-08+) — gated. Остаются только **отложенные опции**
...
## Закрыто (MLC-001..024, 029, 030, 031, 032, 033, 034, 035, 037, 038, 039, 040, 041, 042, 043) — индекс
