...
> Нет активной задачи. Следующую (`MLC-101` — интерактивная страница мастера: SQL + тест
> подключения, hostname/port, генерация `appsettings.Production.json`) ставит куратор.
