...
> Phase 1 (PERF-01..04 = MLC-037/039/038/040) закрыт полностью; из Phase 2 закрыт `MLC-041`** (PERF-05,
> кросс-вызовный кэш UUID кластера — `cluster.list`-спавны и kill/hot-путь срезаны ×2; см. архив).
> Последним выполнен `MLC-041`; остальные пункты перф-плана
> (`compressed-giggling-grove.md`, PERF-06+) — gated. Остаются только **отложенные опции**
...
## Закрыто (MLC-001..024, 029, 030, 031, 032, 033, 034, 035, 037, 038, 039, 040, 041) — индекс
