...
> _Не назначена._ `MLC-081` (+влитая `MLC-080`) закрыта 2026-06-10 — следующую задачу трека
> (по порядку — `MLC-082`) выставляет куратор. Страховочный тег `v1-pre-ux-redesign` стоит на main.
