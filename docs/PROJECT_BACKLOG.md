...
> _Не назначена._ `MLC-083` + `MLC-084` закрыты 2026-06-10 (объединённая сессия, один PR).
> Следующую сессию трека (`MLC-085` + `MLC-086`, два PR: код и канон раздельно) выставляет
> куратор. Тег `v1-pre-ux-redesign` стоит на main.
