...
> **`MLC-082` (UX-B)** — форма инфобазы без выбора сервера; полная постановка — в секции трека
> ниже. Перед стартом: `git fetch` + FF, ветка от `main`. Тег `v1-pre-ux-redesign` стоит на main.
...
- `MLC-082` (UX-B) · Frontend · S · **NEXT TASK** — **форма инфобазы без выбора сервера** (§4.1–4.2). Убрать поле
...
`MLC-001..081` закрыты (кроме отложенных `MLC-025..028`, `036`, `062`, `073` — см. «Открытые
