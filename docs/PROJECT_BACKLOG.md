...
**Нет активной задачи.** Трек «Свежесть данных на страницах» (MLC-154..156) завершён (3/3).
Следующую задачу/трек ставит куратор постановочным PR. Кандидаты — «Открытые опции» ниже
(по триггеру) и `ROADMAP.md`.
...
**Следующий свободный номер: `MLC-158`.** Куратор инкрементирует при выдаче; выдавать занятые
