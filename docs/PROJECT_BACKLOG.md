...
`OPERATIONS.md §8`. Обе правки вошли в релиз **`0.6.4-beta`** (версия забампана). Следующую задачу/трек
ставит куратор постановочным PR.
...
`MLC-001..171` закрыты (кроме отложенных `MLC-025/026/145` — см. «Открытые опции»; `MLC-062`/`073`
