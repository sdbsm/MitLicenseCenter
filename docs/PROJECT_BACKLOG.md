...
> _Не назначена — активных задач нет._ Трек «GUI-установщик (Inno Setup)» **закрыт 2026-06-11**
> (`MLC-098..104`) — секция перенесена в архив, строка в «Завершённые треки» выше.
...
**Следующий свободный номер: `MLC-105`.** Куратор инкрементирует при выдаче; выдавать занятые
