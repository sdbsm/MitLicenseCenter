...
места/авто-стоп, single-active по БД, orphan-recovery), **NDJSON-парсер** собранного ТЖ и
**анализатор управляемых блокировок 1С** (MLC-233); агрегаторы долгих запросов и исключений —
последующие задачи трека (MLC-234/235).
