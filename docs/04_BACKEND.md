...
Это только Infrastructure-слой + интерфейс Application; эндпоинты и frontend появляются с MLC-213+.
800-серия аудита (`OneCServerStarted`/`Stopped`/`Restarted`) объявлена, но пишется эндпоинтами MLC-213+.
...
значения добавлены в MLC-212, пишутся эндпоинтами MLC-213+);
