...
|---|---|---|
| Recurring jobs | Все 4 джоба в статусе «Enqueued» / «Succeeded» | Задание в «Failed» — проверить стек ошибки в Hangfire UI |
...
**Graceful shutdown.** Четыре recurring-джобы регистрируются с плейсхолдером
