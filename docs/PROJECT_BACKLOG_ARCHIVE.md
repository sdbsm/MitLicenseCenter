# MitLicense Center — Backlog Archive (закрытые задачи MLC-001..020)
...
>
> Снимок сделан 2026-06-03 при выносе истории из активного бэклога. Разделы «Как
> пользоваться» / «Формат записи» ниже сохранены как есть — они описывают тот же процесс,
> что и активный файл.
