...
`ObservationMode` или `InvestigationPlaceholder`. Из «Наблюдения» кнопка-CTA «Начать расследование»
...
Экраны расследования (Мастер запуска, Дело, Отчёт, Список дел, Прогресс сбора) **планируются** в
MLC-242..244 и ещё не реализованы. Целевой UX (концепция) — [`30_TARGET_DESIGN.md`](../research/perf-investigation/30_TARGET_DESIGN.md),
