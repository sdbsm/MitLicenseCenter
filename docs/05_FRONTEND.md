...
не выводится, база показывается при наличии. **Мастер** (`InvestigationWizard`, экран 2: сценарий + scope из
