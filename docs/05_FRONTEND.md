...
всё равно показан (кейс «много мелких»). **Мастер** (`InvestigationWizard`, экран 2: сценарий + scope из
