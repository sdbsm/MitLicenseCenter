...
interface ChangePasswordFormProps {
  /** Вызывается после успешной смены (помимо тоста). Профиль ничего не делает,
...
/**
 * Форма смены пароля. Переиспользуется страницей профиля (`/profile`) и блокирующим
 * экраном форс-смены (MLC-059) — обе шлют текущий + новый пароль на
 * `/api/v1/auth/change-password`. Рендерит только `<form>`; обёртку (Card / экран)
