 ...
 * сохраняются, вид/вкладка не сбрасываются. Это и есть ключевое отличие от прежнего
 * подхода страницы `/reports` (удалена в MLC-196c), которая делала полный replace URL
 * (для отдельной страницы это было безопасно — там хост-ключей нет).
 */
