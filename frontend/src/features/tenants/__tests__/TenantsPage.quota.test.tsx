/**
 * Поведенческий тест: MLC-122 / R6 / UX-02 (обновлён MLC-200)
 * В таблице /tenants слитая колонка «Лицензии» (consumed/limit + полоса + ярлык):
 * клиент-нарушитель (≥90%) получает danger-акцент, безлимитный — без акцента.
 * Граничные ярлыки квоты (9/10 nearLimit, 10/10 atLimit, 11/10 exceeded) — по факту
 * consumed vs limit, не по цвету-severity.
 *
